...
// create new PDF document
        $pdf = new TOC_TCPDF(self::PDF_PAGE_ORIENTATION, self::PDF_UNIT, self::PDF_PAGE_FORMAT, true, 'UTF-8', false, false, $this->config);
...
// set default header data
        $pdf->SetHeaderData($this->config->getPdfHeaderLogo(), $this->config->getPdfHeaderLogoWidth(), self::PDF_HEADER_TITLE.' 059', self::PDF_HEADER_STRING);
 ...
 */
class TOC_TCPDF extends \Fooman\Tcpdf\Tcpdf {
