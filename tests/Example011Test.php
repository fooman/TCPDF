...
// create new PDF document
        $pdf = new MYPDF011(self::PDF_PAGE_ORIENTATION, self::PDF_UNIT, self::PDF_PAGE_FORMAT, true, 'UTF-8', false, false, $this->config);
...
// set default header data
        $pdf->SetHeaderData($this->config->getPdfHeaderLogo(), $this->config->getPdfHeaderLogoWidth(), self::PDF_HEADER_TITLE.' 011', self::PDF_HEADER_STRING);
...
class MYPDF011 extends \Fooman\Tcpdf\Tcpdf {
